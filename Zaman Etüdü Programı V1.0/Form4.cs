...
namespace Zaman_Etüdü_Programı_V1._0
{
    public partial class Form4 : Form
    {
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            OleDbCommand komut1 = new OleDbCommand("insert into Tablo1 ([projekodu],[projeadı],[operatör],[faaliyet],[whesting],[tempolama],[paymiktarı],[stdzaman],[nrmlzaman]) values ('" + comboBox4.Text + "','" + comboBox1.Text + "','" + comboBox2.Text + "','" + comboBox3.Text + "','" + son + "','" + textBox2.Text + "','" + sonuc2 + "','" + stdzaman + "','" + normzamn + "')", baglanti);
            komut1.ExecuteNonQuery();
            baglanti.Close();
            listBox1.Items.Add("ProjeKodu: " + comboBox4.Text + "\t" + "ProjeAdı: " + comboBox1.Text + "\t" + "Operatör: " + comboBox2.Text + "\t" + "Faaliyet: " + comboBox3.Text + "\t" + "Whesting House Sonuçlar: " + son + "\t" + "Tolerans Değeri: " + textBox2.Text + "\t" + "Pay Miktarı Sonuçları: " + sonuc2 + "\t" + "Standart Zaman: " + stdzaman);
        }
        ...
        {
            if (radioButton8.Checked == false && radioButton7.Checked == false && radioButton6.Checked == false && radioButton5.Checked == false && radioButton10.Checked == false && radioButton9.Checked == true)
            {
                double s2 = 0.06;
                topla2 = topla2 + s2;
                MessageBox.Show("0.06");
